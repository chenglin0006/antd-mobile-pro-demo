...
const common = {
  ...
  empUrlFilter: '/employeeServiceCenterApi', // 内部服务
  ossFilter: '/api',
...
const url = {
  ...
  development: {
    ...
    hrmUrl: 'http://localhost.bnq.com.cn:8050',
    // 本地测试地址
  ...
  test: {
    ...
    empUrl: 'https://empcsc-test.bnq.com.cn', // 内部服务
  },
  uat: {
    ...common,
    ...
    empUrl: 'https://empcsc-uat.bnq.com.cn', // 内部服务
  },
  // 生产环境 - prod
  prod: {
    ...common,
    ...
    empUrl: 'https://empcsc.bnq.com.cn', // 内部服务
  },
};
